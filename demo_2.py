...
import warnings
import logging
log_format = '%(asctime)s - DEMO2 - %(levelname)s - %(message)s'
logging.basicConfig(filename='demo_2.20230705.out.log', level=logging.INFO, filemode='w',format=log_format)
...
def main(args):
            ...
            for image_path in image_path_list:
                ...
                if total_file_number%50==0:
                    ...
                    logging.info(
                        ...
                        "Image_top1_acc: {:.3f}%, Image_top5_acc: {:.3f}%, Text_top1_acc: {:.3f}%, Text_top5_acc: {:.3f}%. ".format(
    ...
    logging.info(
        "[RESULT] Image_top1_acc: {}%, Image_top5_acc: {}%, Text_top1_acc: {}%, Text_top5_acc: {}%".format(
            image_correct_top1*100/total_file_number,
            image_correct_top5*100/total_file_number,
            text_correct_top1*100/total_file_number,
            text_correct_top5*100/total_file_number,
