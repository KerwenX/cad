...
def get_args_parser():
    ...
    parser.add_argument('--test_ckpt_addr', default='/home/aston/Desktop/python/cad-match/outputs/reproduce_pointbert_8kpts_only_image/checkpoint_2501.pt', help='the ckpt to test 3d zero shot')
...
with torch.no_grad():
    ...
    with open('ULIP_PointBERT_cads_feature_only_image.pkl','wb') as f:
