...
import warnings
import logging
log_format = '%(asctime)s - DEMO - Concate - GT cat - %(levelname)s - %(message)s'
logging.basicConfig(filename='demo_concate_GT_cat.out.log', level=logging.INFO, filemode='a',format=log_format)
...
def get_args_parser():
    ...
    # parser.add_argument('--test_ckpt_addr', default='/home/aston/Desktop/python/CAD-Matching/outputs/saved/712/checkpoint_last.pt', help='the ckpt to test 3d zero shot')
    ...
    with torch.no_grad():
        for dirname in dirname_list:
            ...
            for image_path in image_path_list:
                ...
                logits_per_concate_pc = logit_scale * concate_embed @ pc_embed.t()
                ...
                _, concate_retrival_top5 = torch.topk(logits_per_concate_pc, k=top_k)
                ...
                concate_pc_retrieval_namelist = [filename_list[cat_cad_index_list[index]] for index in concate_retrival_top5[0]]
...
# retrieval CAD with concate feature and GT category
